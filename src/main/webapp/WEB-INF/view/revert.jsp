        ...
        <div class="row">
            <header class="col-md-2">
                <div class="logo">
                 ...
                 <div class="nav">
                    <ul>
                      <li><a href="" class="glyphicon glyphicon-camera">台北市</a></li>
                        <li><a href="" class="glyphicon glyphicon-heart-empty">新北市</a></li>
                        <li><a href="" class="glyphicon glyphicon-cutlery">桃園市</a></li>
                        <li><a href="" class="glyphicon glyphicon-gift">台中市</a></li>
                        <li><a href="" class="glyphicon glyphicon-blackboard">高雄市</a></li>
                    </ul>
                </div>
            </header>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        ...
				        <h4 class="modal-title">回覆評論</h4>
				      </div>
                       <form action="addRevert" method="post">
	                       <div class="modal-body">
											<label for="exampleInputEmail1">回覆評論內容</label>
					      ...
					      <div class="modal-footer">
								<input class="btn btn-default" data-dismiss="modal" type="button" value="關閉"/>
	                            
	                            <input type="submit" class="btn btn-primary" value="張貼回覆"/>
							</div>
                       </form>
				    </div><!-- /.modal-content -->
				  </div><!-- /.modal-dialog -->
                ...
                <div class="publish" style="width:850px">
                       <div class="row" style="width:850px">
                         <div class="col-sm-9">
                            ...
                            <p class="text-muted hidden-xs">地區：${product.productbrand } </p>
                            <p class="hidden-xs">${product.productdes }</p>
                            <p class="text-muted">房屋價格：${product.productprice }萬元 <span class="hidden-xs">類型：${product.productmodel } </span>
                            </p>
                         </div>
                      ...
                      <div class="row" style="width:850px">
	                      <div class="col-sm-9" style="width:850px">
	                         ...
	                         <p class="hidden-xs"> ${rcount }個回覆  時間:${message.writedate }
	                          <button type="button" class="btn btn-primary searchAll">查看回覆評論</button>
                             <button data-toggle="modal" data-target=".login" class ="btn btn-info glyphicon glyphicon-pencil">回覆評論</button>  </p>
	                      </div>
                     </div> 
                </div>     
...
$.each(prods,function (index, revert) {
    ...
    var sp = $("<span></span>").addClass("hidden-xs").append("  時間:"+revert.writedate+" ");
    p2.append(sp);
