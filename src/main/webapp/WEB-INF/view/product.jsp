        ...
        <div class="row">
            ...
            <div class="modal fade login" tabindex="-1" role="dialog">
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        ...
				        <h4 class="modal-title">發表評論</h4>
				      </div>
                       <form action="addMessage" method="post">
	                       <div class="modal-body">
									<label for="exampleInputEmail1">評論內容</label>
					      ...
					      <div class="modal-footer">
								<input class="btn btn-default" data-dismiss="modal" type="button" value="取消"/>
	                            
	                            <input type="submit" class="btn btn-primary" value="張貼評論"/>
							</div>
                       </form>
				    </div><!-- /.modal-content -->
				  </div><!-- /.modal-dialog -->
                ...
                <div class="publish" style="width:850px">
                      ...
                      <div class="row" style="width:850px">
                                                      評論數(${mcount })&nbsp;&nbsp;&nbsp;&nbsp;
                      <button type="button" class="btn btn-primary searchAll">查看評論</button>
                      <button data-toggle="modal" data-target=".login" class ="btn btn-info glyphicon glyphicon-pencil">發表評論</button>
                     </div> 
                </div>     
...
function build_messlist_table(result) {
    ...
    $.each(prods,function (index, message) {
        ...
        var p2 = $("<p></p>").addClass("hidden-xs").append("回覆數:"+message.count+"  ");
        var p3 = $("<p></p>").append(im).append(p1);
        var sp = $("<span></span>").addClass("hidden-xs").append("  時間:"+message.writedate+" ");
        p2.append(sp);
